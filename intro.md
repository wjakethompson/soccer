...
#>  cran (@1.62.0-)                  
#>  CRAN (R 3.3.0)                   
#>  Github (rstudio/bookdown@5907a5d)
#>  CRAN (R 3.3.0)                   
#>  cran (@1.17.1)                   
#>  CRAN (R 3.3.0)                   
#>  cran (@2.3)                      
...
#>  cran (@1.0.2)                    
#>  cran (@1.1.2)                    
#>  Github (hadley/purrr@4ab056f)    
#>  CRAN (R 3.3.0)                   
#>  cran (@2.2.0)                    
#>  CRAN (R 3.3.0)                   
#>  Github (RcppCore/Rcpp@c57b754)   
#>  CRAN (R 3.3.0)                   
#>  cran (@0.8.6)                    
#>  cran (@1.4.2)                    
#>  Github (hadley/rlang@b22ce1c)    
#>  cran (@1.5)                      
#>  CRAN (R 3.3.0)                   
#>  cran (@1.2)                      
#>  CRAN (R 3.3.2)                   
